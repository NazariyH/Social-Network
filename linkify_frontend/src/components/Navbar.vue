    ...
    <div id="navbar-wrap" class="side-block active sticky top-0">
        ...
        <nav class="w-full h-full p-8 flex flex-col justify-between items-center">
            ...
            <ul class="text-sm w-full">
                <li class="navbar-tab">
                    <router-link class="flex items-center"><i class="fa-solid fa-compass text-xl mr-6"></i><span class="navbar-text-link hidden">News Feed</span></router-link>
                </li>
                <li class="navbar-tab active">
                    <router-link class="flex items-center"><i class="fa-solid fa-message text-xl mr-6"></i><span class="navbar-text-link hidden">Messages</span></router-link>
                    <div class="badge hidden">3</div>
                </li>
                <li class="navbar-tab">
                    <router-link class="flex items-center"><i class="fa-solid fa-comment-dots text-xl mr-6"></i><span class="navbar-text-link hidden">Forums</span></router-link>
                </li>
                <li class="navbar-tab">
                    <router-link class="flex items-center"><i class="fa-solid fa-user-group text-xl mr-5"></i><span class="navbar-text-link hidden">Friends</span></router-link>
